...
mod transaction {
    ...
    use neptune_cash::models::blockchain::transaction::validity::collect_lock_scripts::CollectLockScripts;
    use neptune_cash::models::blockchain::transaction::validity::collect_lock_scripts::CollectLockScriptsWitness;
    use neptune_cash::models::blockchain::transaction::validity::collect_type_scripts::CollectTypeScripts;
    use neptune_cash::models::blockchain::transaction::validity::collect_type_scripts::CollectTypeScriptsWitness;
    use neptune_cash::models::blockchain::transaction::validity::kernel_to_outputs::KernelToOutputs;
    use neptune_cash::models::blockchain::transaction::validity::kernel_to_outputs::KernelToOutputsWitness;
    use neptune_cash::models::blockchain::transaction::validity::removal_records_integrity::RemovalRecordsIntegrity;
