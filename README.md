...
## Running & Connecting
 ...
 - Run neptune-core daemon: `neptune-core` with flags
   - `--peers [ip_address:port]` to connect to a given peer, for instance `--peers 51.15.139.238:9798` or `--peers 139.162.193.206:9798` or `--peers [2001:bc8:17c0:41e:46a8:42ff:fe22:e8e9]:9798` or `--peers 51.158.203.7:9798`.
