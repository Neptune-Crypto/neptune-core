...
RUN apt-get update && apt-get install -y curl build-essential libleveldb-dev libsnappy-dev cmake git cargo rustc
...
ENTRYPOINT ["./neptune-core", "--peers", "51.15.139.238:9798", "--peers", "139.162.193.206:9798", "--peers", "[2001:bc8:17c0:41e:46a8:42ff:fe22:e8e9]:9798"]
