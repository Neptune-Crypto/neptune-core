...
mod test_support {
    ...
    use super::*;
    use crate::block::proof_of_work_puzzle::ProofOfWorkPuzzle;
...
proptest::prop_compose! {
    ...
    pub fn arbitrary_kernel() (
        ...
        transaction_kernel in crate::transaction::test_helpers::txkernel::default(true),
...
pub(crate) mod tests {
    ...
    #[test]
    fn genesis_block_hasnt_changed_testnet_0() {
        assert_eq!(
