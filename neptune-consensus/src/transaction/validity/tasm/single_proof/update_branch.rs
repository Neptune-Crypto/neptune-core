...
impl UpdateWitness {
    /// The transaction kernel of the out-of-date transaction.
    pub fn old_kernel(&self) -> &TransactionKernel {
        &self.old_kernel
    }

    /// The transaction kernel of the updated transaction.
    pub fn new_kernel(&self) -> &TransactionKernel {
        &self.new_kernel
    }
...
/// Test-support constructors for [`UpdateWitness`].
...
pub mod test_helpers {
    ...
    pub async fn deterministic_update_witness_additions_and_removals(
        num_inputs: usize,
        num_outputs: usize,
    ...
    /// additions.
    pub async fn deterministic_update_witness_only_additions_to_mutator_set(
        num_inputs: usize,
        num_outputs: usize,
        num_pub_announcements: usize,
        consensus_rule_set: ConsensusRuleSet,
