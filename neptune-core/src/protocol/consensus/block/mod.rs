...
impl Block {
    ...
    #[cfg(test)]
    pub(crate) fn set_unparseable_lustration_status(&mut self) {
    ...
    #[cfg(test)]
    pub(crate) fn kernel_mut(&mut self) -> &mut BlockKernel {
        self.unset_digest();
        &mut self.kernel
    }
    ...
    #[cfg(test)]
    pub(crate) fn proof_mut(&mut self) -> &mut BlockProof {
        self.unset_digest();
        &mut self.proof
    }
...
pub(crate) mod tests {
    ...
    impl Block {
        ...
        pub(crate) fn fix_mutator_set_fields(&mut self, prev_block: &Block) {
