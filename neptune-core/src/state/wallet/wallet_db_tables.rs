...
pub(super) struct WalletDbTables {
    ...
    /// Total number of secret address keys generated by this wallet.
    pub(super) secret_address_key_counter: DbtSingleton<u64>,
}
...
impl WalletDbTables {
    ...
    pub(super) async fn load_schema_in_order(storage: &mut SimpleRustyStorage) -> WalletDbTables {
        ...
        let secret_address_key_counter = storage
            .schema
            .new_singleton::<u64>("secret_address_key_counter")
            .await;
