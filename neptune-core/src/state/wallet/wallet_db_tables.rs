...
pub(super) struct WalletDbTables {
    ...
    /// The total number of private address keys generated by this wallet.
    // table number 14
    ...
    // anyway.
    pub(super) private_address_key_counter: DbtSingleton<u64>,
}
...
impl WalletDbTables {
    ...
    pub(super) async fn load_schema_in_order(storage: &mut SimpleRustyStorage) -> WalletDbTables {
        ...
        let private_address_key_counter = storage
            .schema
            .new_singleton::<u64>("private_address_key_counter")
            .await;
