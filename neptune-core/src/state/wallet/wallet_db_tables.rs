...
pub(super) struct WalletDbTables {
    ...
    /// and this check can be performed fast. And it must be accompanied by an
    /// element in the [`Self::index_set_to_mutxo`] table for fast mapping of
    /// absolute index set to monitored UTXO, such that spent UTXOs can quickly
    /// be identified.
