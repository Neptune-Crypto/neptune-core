...
pub struct WalletState {
    ...
    /// Cache of secret address keys generated by this wallet.
...
impl WalletState {
    ...
    /// An iterator over all known secret address spending keys.
    ...
    pub async fn next_unused_secret_address_key(&mut self) -> secret_address::SecretAddressKey {
        ...
        self.known_secret_address_keys.push(key.clone().into());
    ...
    /// Get the next n secret address keys spending keys (with derivation
...
pub(crate) mod tests {
    ...
    pub(crate) mod scan_mode {
        ...
        async fn get_future_keys_do_not_modify_counters() {
            ...
            let secret_address_counter = wallet_state.wallet_db.get_secret_address_key_counter();
            ...
            let future_symmetric_keys = wallet_state
                ...
                .collect_vec();
            let future_secret_address_keys = wallet_state
                .get_future_secret_address_keys(num_future_keys)
                .collect_vec();
            ...
            assert_eq!(
                secret_address_counter,
                wallet_state.wallet_db.get_secret_address_key_counter(),
            );
            ...
            black_box(future_secret_address_keys);
        }
        ...
        async fn scan_for_utxos_announced_to_future_keys_behaves(
            ...
            mut future_secret_address_relative_indices: Vec<usize>,
            ...
            let generation_counter = wallet_state.wallet_db.get_generation_key_counter();
            let symmetric_counter = wallet_state.wallet_db.get_symmetric_key_counter();
            let secret_counter = wallet_state.wallet_db.get_secret_address_key_counter();
            ...
            let future_symmetric_keys = future_symmetric_relative_indices
                ...
                .collect_vec();
            future_secret_address_relative_indices.sort();
            let future_secret_keys = future_secret_address_relative_indices
                .into_iter()
                ...
                .map(|(relative_index, absolute_index)| {
                    (
                        ...
                        relative_index,
                        absolute_index,
                        SpendingKey::from(wallet_secret.nth_secret_address_key(absolute_index)),
                    )
                })
                .collect_vec();
