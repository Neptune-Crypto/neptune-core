...
pub(crate) mod tests {
    ...
    mod expected_utxos {
        ...
        #[apply(shared_tokio_runtime)]
        async fn no_expected_utxos_on_custom_coinbase_distribution() {
            let network = Network::Main;
            let wallet = WalletEntropy::devnet_wallet();
            ...
            for coinbase_distribution in [None, Some(coinbase_distribution)] {
                ...
                let expected_num_outputs = if coinbase_distribution.is_some() {
                    3
                } else {
                    2
                };
                ...
                let expected_num_own_outputs = if coinbase_distribution.is_some() {
                    0
                } else {
                    2
                };
