...
| Error IDs | Snippet(s)                                                                                                                      |
|----------:|:------------------------------------------------------------------------------------------------------------------------------- |
|     0..10 | [`RemovalRecordsIntegrity`](protocol/consensus/transaction/validity/removal_records_integrity.rs)                               |
|    10..20 | `AuditVmEndState` (now deleted)                                                                                                 |
|    20..30 | [`merge::AuthenticateCoinbaseFields`](protocol/consensus/transaction/validity/tasm/merge/authenticate_coinbase_fields.rs)       |
|    30..50 | [`NativeCurrency`](models/blockchain/type_scripts/native_currency.rs)                                                           |
|    50..70 | [`SingleProof`](protocol/consensus/transaction/validity/single_proof.rs)                                                        |
|    70..80 | [`MergeBranch`](protocol/consensus/transaction/validity/tasm/single_proof/merge_branch.rs)                                      |
...
|  260..270 | [`CollectLockScripts`](protocol/consensus/transaction/validity/collect_lock_scripts.rs)                                         |
|  270..280 | [`KernelToOutputs`](protocol/consensus/transaction/validity/kernel_to_outputs.rs)                                               |
|  300..400 | [`LockScript`](protocol/consensus/transaction/lock_script.rs)                                                                   |
