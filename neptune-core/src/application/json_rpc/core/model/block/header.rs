...
use crate::application::json_rpc::core::model::block::transaction_kernel::RpcTransactionKernelLeanInputs;
...
pub struct TransactionKernelWithPriority {
    /// The kernel of the transaction, without membership proofs for the inputs.
    pub kernel: RpcTransactionKernelLeanInputs,
