...
RUST_BACKTRACE=1 XDG_DATA_HOME=~/.local/share/neptune-integration-test/0/ nice -n 18 -- cpulimit -l 35 -- cargo run -- --network regtest --peer-port 29790 --rpc-port 19790 --mine 2>&1 | tee -a advanced_integration_test.log | sed 's/.*neptune_core:\+\(.*\)/I0:  \1/g' &
pid[0]=$!
sleep 5s;
RUST_BACKTRACE=1 XDG_DATA_HOME=~/.local/share/neptune-integration-test/1/ nice -n 18 -- cpulimit -l 35 -- cargo run -- --network regtest --peer-port 29791 --rpc-port 19791 --peers 127.0.0.1:29790 2>&1 | tee -a advanced_integration_test.log | sed 's/.*neptune_core:\+\(.*\)/I1:  \1/g' &
pid[1]=$!
sleep 2s;
RUST_BACKTRACE=1 XDG_DATA_HOME=~/.local/share/neptune-integration-test/2/ nice -n 18 -- cpulimit -l 35 -- cargo run -- --network regtest --peer-port 29792 --rpc-port 19792 --mine --peers 127.0.0.1:29791 2>&1 | tee -a advanced_integration_test.log | sed 's/.*neptune_core:\+\(.*\)/I2:  \1/g' &
pid[2]=$!
sleep 2s;
RUST_BACKTRACE=1 XDG_DATA_HOME=~/.local/share/neptune-integration-test/3/ nice -n 18 -- cpulimit -l 35 -- cargo run -- --network regtest --peer-port 29793 --rpc-port 19793 --peers 127.0.0.1:29792 2>&1 | tee -a advanced_integration_test.log | sed 's/.*neptune_core:\+\(.*\)/I3:  \1/g' &
pid[3]=$!
sleep 2s;
RUST_BACKTRACE=1 XDG_DATA_HOME=~/.local/share/neptune-integration-test/4/ nice -n 18 -- cpulimit -l 35 -- cargo run -- --network regtest --peer-port 29794 --rpc-port 19794 --peers 127.0.0.1:29790 --peers 127.0.0.1:29791 --peers 127.0.0.1:29792 --peers 127.0.0.1:29793 2>&1 | tee -a advanced_integration_test.log | sed 's/.*neptune_core:\+\(.*\)/I4:  \1/g' &
pid[4]=$!
sleep 2s;
