...
impl Mempool {
    ...
    pub(super) fn update_with_block(
        &mut self,
        new_block: &Block,
    ) -> (Vec<MempoolEvent>, Vec<MempoolUpdateJob>) {
...
mod tests {
    ...
    mod mutator_set_updates {
        use super::*;
        use crate::tests::shared::fake_deterministic_successor;
        ...
        async fn tx_ms_updating() {
            ...
            for tx_proving_capability in [
                ...
                let (_, update_jobs) = mempool.update_with_block(&block1);
                ...
                assert!(
                    mempool
                        ...
                        .unwrap()
                        .clone()
                        .is_confirmable_relative_to(&block1.mutator_set_accumulator_after()),
                    "PW-transaction must be updatable"
                );
            }
        }
    }
    ...
    mod proof_upgrade_candidates {
        ...
        async fn sp_update_only_returns_unsynced_txs() {
            ...
            .await;
            let (_, returned_jobs) = mempool.update_with_block(&block1);
