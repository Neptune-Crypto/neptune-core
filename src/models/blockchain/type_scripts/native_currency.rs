...
pub mod test {
    ...
    use crate::models::proof_abstractions::tasm::program::test::TestableConsensusProgram;
    use crate::models::proof_abstractions::tasm::program::ConsensusError;
    use crate::models::proof_abstractions::verifier::verify;

    impl TestableConsensusProgram for NativeCurrency {
        fn source(&self) {
            ...
            let total_output_plus_fee: NeptuneCoins =
