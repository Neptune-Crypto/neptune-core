...
mod block_tests {
    ...
    #[traced_test]
    #[tokio::test]
    async fn put_get_block_into_database_test() -> Result<()> {
        // Store a block to the database, read it from the database and
        ...
        block_dbs
            ...
            .await
            .block_hash_to_block
            .put(block_1.hash, block_1.clone());
        let read_out = block_dbs
            .lock()
            .await
            .block_hash_to_block
            .get(block_1.hash)
            .unwrap();
        assert_eq!(block_1, read_out);
        assert_eq!(block_1.hash, read_out.hash);
