...
mod accumulation_scheme_tests {
    ...
    fn test_membership_proof_update_from_add() {
        ...
        let addition_record =
            commit::<H>(&own_item, &sender_randomness, &H::hash(&receiver_preimage));
    ...
    fn test_add_and_prove() {
        ...
        let addition_record =
            commit::<H>(&item0, &sender_randomness0, &H::hash(&receiver_preimage0));
        ...
        let addition_record =
            commit::<H>(&item1, &sender_randomness1, &H::hash(&receiver_preimage1));
    ...
    fn batch_update_from_addition_and_removal_test() {
        ...
        for num_additions in num_additions_list {
            for _ in 0..num_additions {
                ...
                let addition_record =
                    commit::<H>(&new_item, &sender_randomness, &H::hash(&receiver_preimage));
